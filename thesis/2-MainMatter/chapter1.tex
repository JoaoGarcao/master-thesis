...
\begin{itemize}
    ...
    \item Chapter~\ref{cha:future} outlines the work plan for completing the dissertation, including the task schedule for consolidating the proposed framework.
\end{itemize}
