...
The generic \texttt{CRDT} interface is limited to merge and comparison operations and therefore does not include update operations such as \texttt{increment}. To work within this restriction, the \texttt{GCounter}, presented in Listing~\ref{list:gcounter_why3}, adopts a structure using two modules, with the update logic defined separately in an auxiliary module, \texttt{GCAuxiliary}.
