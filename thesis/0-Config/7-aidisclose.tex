...
\AIDtoolsUsed{Gemini 3 Pro, NotebookLM, Grammarly}

% --- Optional extra note/comment ---
\begin{AIDcomment}
The AI was used primarily to clarify issues related to Latex code and english words to unlock writing.
\end{AIDcomment}

\begin{AIDcomment}
AI tools where also used to assure writing correctness.
\end{AIDcomment}
