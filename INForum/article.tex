...
Ferramentas automatizadas com recurso a SMT solvers, como a linguagem VeriFx, são altamente eficazes na validação rápida de propriedades algébricas de convergência. No entanto, esbarram em limites de expressividade quando necessitam de raciocinar sobre estruturas recursivas não limitadas ou sobre invariantes de estado globais. Por outro lado, plataformas de verificação dedutiva como o Why3 oferecem o poder expressivo necessário para estabelecer semânticas correct by construction, recorrendo a contratos explícitos e ghost code. A grande desvantagem desta abordagem reside no esforço manual exigido e na exigente aprendizagem imposta aos programadores.
